...
public class TwitterTopicMapper {
	...
	public Topic map(JsonObject jsonTwitterTopic){
		...
		twitterTopic.setPreviewImageUrl(jsonTwitterTopic.get("entities").getAsJsonObject().get("media").getAsJsonArray().get(0).getAsJsonObject().get("media_url").getAsString());
		twitterTopic.setShowContentUrl(jsonTwitterTopic.get("entities").getAsJsonObject().get("media").getAsJsonArray().get(0).getAsJsonObject().get("url").getAsString());
